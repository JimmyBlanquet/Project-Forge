...
|----------|-----------|---------|-------------|
| `NEXT_PUBLIC_SUPABASE_URL` | URL prod | URL dev/staging | URL locale |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | Cle prod | Cle dev | Cle locale |
| `SUPABASE_SERVICE_ROLE_KEY` | Cle prod | Cle dev | Cle locale |
