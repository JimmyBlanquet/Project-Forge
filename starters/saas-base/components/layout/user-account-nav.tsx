...
export function UserAccountNav() {
  ...
  // For now, assume user metadata contains role
  // You'll need to sync this from profiles table
    ...
    return (
      <Drawer.Root open={open} onClose={closeDrawer}>
        <Drawer.Trigger onClick={() => setOpen(true)}>
          <UserAvatar
            user={{ name: user.user_metadata?.name || user.email || null, image: user.user_metadata?.avatar_url || null }}
