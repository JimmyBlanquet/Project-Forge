...
- Check Neon dashboard for DB status
...
- Check if migrations are pending: `pnpm prisma db push`

**Auth broken:**
- Check Auth.js logs (enable debug: `AUTH_DEBUG=true`)
...
- Verify `RESEND_API_KEY` and sender domain
