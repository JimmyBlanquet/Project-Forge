---
name: speckit-audit-sdlc
description: >
  Audit the software development lifecycle (SDLC) maturity of the current project. Scans the codebase, CI/CD configs,
  testing setup, security tools, documentation, and operational readiness, then produces a scored report with a
  prioritized action plan. Use this skill when the user wants to assess project health, check SDLC coverage, run a
  maturity audit, find gaps in their development workflow, compare their project to industry standards, or get
  recommendations for improvement. Also triggers on "audit sdlc", "project health check", "what am I missing",
  "maturity assessment", "how production-ready am I", "gap analysis", "check my project", "what should I improve",
  "development best practices check", or "sdlc review". This is a read-only diagnostic skill — it does NOT fix issues,
  only reports findings and recommends actions. Designed for AI-first solo developer workflows with the 80/20 rule in
  mind: maximum impact, minimum effort.
effort: high
---
